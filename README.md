...
4. Optional: By default all platforms ('mastodon', 'X', 'bluesky') are targeted. Remove a label if you want to skip a platform.
5. Submit the issue with the "Create" button
